        ...
        options: [
            {
                ...
                consequence: { score: 5, time: 60, resources: { budget: -2_500_000 } }
            },
            {
                id: 'opt_2',
                title: 'Delegar a asesor externo',
                description: 'Demora pero reduce riesgo',
                consequence: { score: 0, time: 120, resources: { budget: -12_500_000 } }
            }
        ],
        severity: 'low',
        icon: '📋'
        ...
        options: [
            {
                ...
                consequence: { score: 20, time: 180, resources: { community: 15 } }
            },
            {
                id: 'opt_2',
                title: 'Ofrecer compensación inicial',
                description: 'Ayuda pero no resuelve completamente',
                consequence: { score: 5, time: 120, resources: { budget: -15_000_000, community: 5 } }
            },
            {
                id: 'opt_3',
        ...
        options: [
            {
                ...
                consequence: { score: 15, time: 90, resources: { budget: -25_000_000, community: 10 } }
            },
            {
                id: 'opt_2',
                title: 'Negociar acceso temporal',
                description: 'Solución rápida pero frágil',
                consequence: { score: -5, time: 30, resources: { budget: -2_500_000 } }
            }
        ],
        severity: 'high',
        icon: '🚫'
        ...
        options: [
            {
                ...
                consequence: { score: 10, time: 0, resources: { budget: -35_000_000 } }
            },
            {
                id: 'opt_2',
        ...
        options: [
            {
                ...
                consequence: { score: 20, time: 120, resources: { budget: -30_000_000, water: -2 } }
            },
            {
                id: 'opt_2',
                title: 'Argumentar fuente externa',
                description: 'Riesgos de rechazo regulatorio',
                consequence: { score: -10, time: 60, resources: { budget: -7_500_000 } }
            }
        ],
        severity: 'high',
        icon: '💧'
        ...
        options: [
            {
                ...
                consequence: { score: 0, time: 0, resources: { water: -5 } }
            },
            {
                id: 'opt_2',
                title: 'Implementar sistema de reciclaje',
                description: 'Inversión adicional',
                consequence: { score: 15, time: 90, resources: { water: -3, budget: -15_000_000 } }
            }
        ],
        severity: 'medium',
        icon: '🌡️'
        ...
        options: [
            {
                ...
                consequence: { score: 25, time: 150, resources: { budget: -25_000_000, land: -4 } }
            },
            {
                id: 'opt_2',
                title: 'Modificar límites del proyecto',
                description: 'Reduce impacto pero cambios mayores',
                consequence: { score: 10, time: 60, resources: { land: -5 } }
            }
        ],
        severity: 'high',
        icon: '🦜'
        ...
        options: [
            {
                ...
                consequence: { score: 10, time: 120, resources: { budget: -20_000_000 } }
            },
            {
                id: 'opt_2',
        ...
        options: [
            {
                ...
                consequence: { score: 20, time: 60, resources: { budget: -10_000_000 } }
            },
            {
                id: 'opt_2',
                title: 'Solicitar prórroga',
        ...
        options: [
            {
                ...
                consequence: { score: 15, time: 180, resources: { budget: -60_000_000, land: -3 } }
            },
            {
                id: 'opt_2',
        ...
        options: [
            {
                ...
                consequence: { score: 10, time: 90, resources: { budget: -25_000_000 } }
            },
            {
                id: 'opt_2',
            ...
            options: [
                {
                    ...
                    impact: { community: 8, budget: -55_000_000, impact: -3 }
                },
                {
                    id: 'opt_force',
                    title: 'Proceder con fuerza legal',
                    description: 'Ejecutar órdenes judiciales',
                    impact: { community: -20, impact: 10, budget: -15_000_000 }
                }
            ]
        },
        {
            ...
            options: [
                {
                    ...
                    impact: { community: 5, water: 6, budget: -100_000_000 }
                },
                {
                    id: 'opt_coverup',
                    title: 'Encubrimiento parcial',
                    description: 'Negar conocimiento de prohibición',
                    impact: { community: -15, impact: 5, budget: -30_000_000 }
                }
            ]
        }
    ]
